...
If the DaoAI calibration object is unavailable, DaoAI hand-eye calibration will also function with the 9x15 grey-white Zivid checkerboards. These boards can be printed out with the PDFs provided below.